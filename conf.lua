...
__BASE_WIDTH__ = size.w
__BASE_HEIGHT__ = size.h


function love.conf(t)
  t.identity =   save_folder                                    -- The name of the save directory (string)
  ...
  t.window.title = program_title                                -- The window title (string)
